...
export const precisions = [
  ...
  { name: "Q3_K_S (GGUF)", value: "Q3_K_S" },
  { name: "Q3_K_M (GGUF)", value: "Q3_K_M" },
  { name: "Q3_K_L (GGUF)", value: "Q3_K_L" },
  { name: "Q4_0 (GGUF)", value: "Q4_0" },
  { name: "Q4_K_S (GGUF)", value: "Q4_K_S" },
  { name: "Q4_K_M (GGUF)", value: "Q4_K_M" },
  { name: "Q5_0 (GGUF)", value: "Q5_0" },
  { name: "Q5_K_S (GGUF)", value: "Q5_K_S" },
...
export const PRECISION_MULTIPLIERS: Record<string, number> = {
  ...
  Q2_K: 6.5, // ~2.5-3 bits per weight, significant speedup
  Q3_K_S: 5.0, // ~3.3 bits per weight
  Q3_K_M: 4.5, // ~3.5 bits per weight
  Q3_K_L: 4.0, // ~3.7 bits per weight
  Q4_0: 3.5, // 4.5 bits per weight (legacy format)
  Q4_K_S: 3.8, // ~4.5 bits per weight
  Q4_K_M: 3.5, // ~4.75 bits per weight
  Q5_0: 2.8, // 5.5 bits per weight (legacy format)
  Q5_K_S: 2.9, // ~5.5 bits per weight
  Q5_K_M: 2.7, // ~5.75 bits per weight
...
export const PRECISION_BYTES: Record<string, number> = {
  ...
  Q3_K_S: 0.413, // ~3.3 bits per weight
  Q3_K_M: 0.438, // ~3.5 bits per weight
  Q3_K_L: 0.463, // ~3.7 bits per weight
  Q4_0: 0.563, // 4.5 bits per weight (legacy format, includes metadata)
  Q4_K_S: 0.563, // ~4.5 bits per weight
  Q4_K_M: 0.594, // ~4.75 bits per weight
  Q5_0: 0.688, // 5.5 bits per weight (legacy format)
  Q5_K_S: 0.688, // ~5.5 bits per weight
  Q5_K_M: 0.719, // ~5.75 bits per weight
