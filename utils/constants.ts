...
export const MODELS: ModelInfo[] = [
  ...
  // Kimi 系列 (Moonshot AI)
  {
    ...
    activeParams: 32,
    isMoE: true,
    source: "Moonshot AI Kimi-K2 official release - 1T MoE model with 256K context",
    verificationUrl: "https://huggingface.co/moonshotai/Kimi-K2-Instruct",
    series: "Kimi K2",
    category: "原始模型",
  },
  {
    ...
    activeParams: 32,
    isMoE: true,
    source: "Moonshot AI Kimi-K2 instruction-tuned model",
    verificationUrl: "https://huggingface.co/moonshotai/Kimi-K2-Instruct",
    series: "Kimi K2",
    category: "原始模型",
  },
  {
    ...
    activeParams: 32,
    isMoE: true,
    source: "Moonshot AI Kimi-K2.5 improved model",
  ...
  // Qwen 3.5 系列 (阿里巴巴)
  {
    ...
    d_model: 8192,
    n_layers: 80,
    source: "Qwen3.5 series flagship model",
    verificationUrl: "https://huggingface.co/Qwen/Qwen3.5-72B",
    series: "Qwen 3.5",
    category: "原始模型",
  },
  {
    ...
    d_model: 6656,
    n_layers: 60,
    source: "Qwen3.5 32B model",
    verificationUrl: "https://huggingface.co/Qwen/Qwen3.5-32B",
    series: "Qwen 3.5",
    category: "原始模型",
  },
  {
    ...
    d_model: 3584,
    n_layers: 28,
    source: "Qwen3.5 7B compact model",
    verificationUrl: "https://huggingface.co/Qwen/Qwen3.5-7B",
    series: "Qwen 3.5",
    category: "原始模型",
  },
  ...
  // MiniMax 系列
  {
    ...
    activeParams: 46,
    isMoE: true,
    source: "MiniMax Text-01 with 1M context window",
    verificationUrl: "https://huggingface.co/MiniMaxAI/MiniMax-Text-01",
    series: "MiniMax",
    category: "原始模型",
  },
  {
    ...
    activeParams: 46,
    isMoE: true,
    source: "MiniMax M1 reasoning model with 1M context",
    verificationUrl: "https://huggingface.co/MiniMaxAI/MiniMax-M1",
    series: "MiniMax M1",
    category: "推理专用",
  },
  {
    ...
    parameters: "456B",
    parametersNum: 456,
    value: "minimax-m1-40k",
    d_model: 7168,
    n_layers: 80,
    activeParams: 46,
    isMoE: true,
    source: "MiniMax M1-40k efficient reasoning model",
    verificationUrl: "https://huggingface.co/MiniMaxAI/MiniMax-M1-40k",
    series: "MiniMax M1",
    category: "推理专用",
  },
  ...
  // GLM-Z1 系列 (智谱AI最新推理模型)
  {
    ...
    d_model: 6656,
    n_layers: 60,
    source: "ZhipuAI GLM-Z1 reasoning model",
    verificationUrl: "https://huggingface.co/THUDM/GLM-Z1-32B",
    series: "GLM-Z1",
    category: "推理专用",
  },
  {
    ...
    d_model: 4096,
    n_layers: 40,
    source: "ZhipuAI GLM-Z1 compact reasoning model",
    verificationUrl: "https://huggingface.co/THUDM/GLM-Z1-9B",
    series: "GLM-Z1",
    category: "推理专用",
  },
