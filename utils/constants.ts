...
export const gpuModels: GPUModel[] = [
  ...
  // NVIDIA Blackwell架构
  {
    ...
    category: "数据中心",
    releaseYear: 2024,
  }, // NVIDIA Blackwell datasheet: 192GB HBM3e, 8 TB/s (replaces earlier low estimate)
  {
    name: "NVIDIA B100",
    memory: 192, // GB
    memoryBandwidthInGB: 8000,
    ...
    category: "数据中心",
    releaseYear: 2024,
  }, // Public B100 spec sheets: 192GB HBM3e, 8 TB/s (replaces earlier low estimate)
  ...
  },
  {
    ...
    releaseYear: 2026,
    memoryBandwidthInGB: 4000,
  }, // 144GB HiZQ 2.0 HBM, 4 TB/s, 1 PFLOPS FP8 (~500 TFLOPS FP16), 2 PFLOPS FP4
  {
...
export const MODELS: ModelInfo[] = [
  ...
  // MiMo 系列 (小米开源MoE推理模型)
  {
    ...
    activeParams: 42,
    isMoE: true,
    source: "MiMo-V2.5-Pro: 1.02T MoE (42B active), 384 experts top-8 routing, hybrid SWA+GA attention, 1M context, 3-layer MTP",
    verificationUrl:
  ...
  },
  {
    ...
    activeParams: 15,
    isMoE: true,
    source: "MiMo-V2.5: 310B MoE (15B active), 256 experts top-8 routing, omnimodal (text/image/video/audio), hybrid SWA+GA attention, 1M context",
    verificationUrl:
  ...
  },
  {
    ...
    activeParams: 15,
    isMoE: true,
    source: "MiMo-V2-Flash: 309B MoE (15B active), 256 experts top-8 routing, hybrid SWA+GA attention, 256K context, 3-layer MTP, 2.5-3.7x faster inference",
    verificationUrl:
